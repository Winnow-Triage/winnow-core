    ...
    public partial class InitialCreatePg : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReportIds = table.Column<Guid[]>(type: "uuid[]", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    SuggestedMergeConfidenceScore = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasReachedMonthlyLimit = table.Column<bool>(type: "boolean", nullable: false),
                    StripeCustomerId = table.Column<string>(type: "text", nullable: true),
                    BillingProvider = table.Column<string>(type: "text", nullable: true),
                    StripeSubscriptionId = table.Column<string>(type: "text", nullable: true),
                    CurrentMonthReports = table.Column<int>(type: "integer", nullable: false),
                    ReportQuota_GraceLimit = table.Column<int>(type: "integer", nullable: false),
                    MonthlyReportLimit = table.Column<int>(type: "integer", nullable: false),
                    CurrentMonthSummaries = table.Column<int>(type: "integer", nullable: false),
                    SummaryQuota_GraceLimit = table.Column<int>(type: "integer", nullable: false),
                    MonthlySummaryLimit = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedConfidenceScore = table.Column<double>(type: "double precision", nullable: true),
