...
public class MergeClusterRequest : Winnow.API.Features.Shared.ProjectScopedRequest
{
...
public sealed class MergeClusterEndpoint(IMediator mediator)
    : Winnow.API.Features.Shared.ProjectScopedEndpoint<MergeClusterRequest, ActionResponse>
{
