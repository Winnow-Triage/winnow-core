...
public class DismissClusterMergeSuggestionRequest : Winnow.API.Features.Shared.ProjectScopedRequest
{
    public Guid Id { get; set; }
}

public sealed class DismissClusterMergeSuggestionEndpoint(IMediator mediator)
    : Winnow.API.Features.Shared.ProjectScopedEndpoint<DismissClusterMergeSuggestionRequest, ActionResponse>
{
