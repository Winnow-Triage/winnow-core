...
namespace Winnow.API.Features.Clusters.Export;

public class ExportClusterRequest : Winnow.API.Features.Shared.ProjectScopedRequest
{
...
public sealed class ExportClusterEndpoint(IMediator mediator)
    : Winnow.API.Features.Shared.ProjectScopedEndpoint<ExportClusterRequest, ExportClusterResponse>
{
