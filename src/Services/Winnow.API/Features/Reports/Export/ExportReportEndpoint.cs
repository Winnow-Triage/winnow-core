...
namespace Winnow.API.Features.Reports.Export;

/// <summary>
/// Request to export a report via an integration.
/// </summary>
public class ExportReportRequest : Winnow.API.Features.Shared.ProjectScopedRequest
{
    /// <summary>
...
public sealed class ExportReportEndpoint(IMediator mediator) : Winnow.API.Features.Shared.ProjectScopedEndpoint<ExportReportRequest, ExportReportResponse>
{
