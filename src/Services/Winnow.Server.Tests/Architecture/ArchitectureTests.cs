...
public class ArchitectureTests
{
    ...
    public void Domain_ShouldNotDependOn_Infrastructure()
    {
        ...
        var result = Types.InAssembly(domainAssembly)
            .That()
            .ResideInNamespace("Winnow.Server.Entities") // Check only Entities
            .ShouldNot()
    ...
    public void VerticalSlices_ShouldNotDependOnEachOther_WithExceptions()
    {
        ...
        // Strategy: Take "Winnow.Server.Features.Reports.Create" -> "Reports"
        ...
        foreach (var slice in slices)
        {
            ...
            foreach (var otherSliceNamespace in otherSlices)
            {
                ...
                if (slice == "Debug" && otherSliceNamespace == "Winnow.Server.Features.Reports")
                {
    ...
    public void Services_ShouldImplementMatchingInterface_OrBeProviders()
    {
        ...
        var serviceTypes = Types.InAssembly(assembly)
            .That()
            .ResideInNamespace("Winnow.Server.Services")
            .Or()
    ...
    public void Infrastructure_ShouldNotBeUsedInFeatures_ExceptAllowedNamespaces()
    {
        ...
        {
            "Winnow.Server.Infrastructure.Persistence",
            "Winnow.Server.Infrastructure.MultiTenancy",
            "Winnow.Server.Infrastructure.Scheduling",
    ...
    public void ApplicationAsyncMethods_ShouldHaveAsyncSuffix()
    {
        ...
        foreach (var method in asyncMethods)
        {
            ...
            if (namespaceName.Contains("Winnow.Server.Features") ||
                ...
                namespaceName.Contains("Winnow.Server.Domain"))
            {
