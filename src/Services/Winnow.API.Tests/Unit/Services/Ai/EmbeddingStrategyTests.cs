...
public class OnnxEmbeddingProviderTests
{
    ...
    [Fact]
    public async Task GetEmbeddingAsync_WhenNoSession_ThrowsInvalidOperationException()
    {
        // Arrange
        var provider = new OnnxEmbeddingProvider(_loggerMock.Object, _hostEnvMock.Object);
...
public class LocalEmbeddingProviderTests
{
    ...
    [Fact]
    public async Task GetEmbeddingAsync_WithMissingConfig_ThrowsInvalidOperationException()
    {
        // Arrange
        var settings = new LlmSettings
        {
    ...
    [Fact]
    public async Task GetEmbeddingAsync_WithApiError_ThrowsHttpRequestException()
    {
        // Arrange
        var settings = new LlmSettings
        {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<HttpRequestException>(() => provider.GetEmbeddingAsync(text));
    }
