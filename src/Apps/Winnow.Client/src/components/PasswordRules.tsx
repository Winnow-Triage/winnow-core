...
export const passwordRules = [
    { label: "Between 8 and 128 characters", test: (p: string) => p.length >= 8 && p.length <= 128 },
...
export function PasswordRules({ password, className }: PasswordRulesProps) {
    return (
        <div className={cn("space-y-2 p-3 bg-muted/50 rounded-lg border border-border/50 text-sm", className)}>
