      ...
      <DialogContent className="sm:max-width-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground leading-relaxed">
              Winnow helps engineering teams cut through the noise by
              automatically clustering related errors, prioritizing critical
              issues, and providing AI-powered recovery suggestions.
            </p>
        ...
        <div className="flex justify-center border-t pt-4">
          <p className="text-[10px] text-muted-foreground uppercase tracking-widest">
            Handcrafted by Winnow Triage, LLC • &copy;{" "}
