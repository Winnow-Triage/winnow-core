            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative opacity-50 cursor-not-allowed">
                  <Button variant="outline" className="w-full text-md pointer-events-none" type="button" tabIndex={-1}>
                    <Github className="mr-2 h-4 w-4" />
                    GitHub
                  </Button>
                  <div className="absolute -top-2.5 -right-2 z-10 flex">
                    <span className="bg-primary/10 text-primary text-[9px] font-bold px-1.5 py-0.5 rounded-full uppercase border border-primary/20 shadow-sm backdrop-blur-sm whitespace-nowrap">
                      Coming Soon
                    </span>
                  </div>
                </div>
                <div className="relative opacity-50 cursor-not-allowed">
                  <Button variant="outline" className="w-full pointer-events-none" type="button" tabIndex={-1}>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase mt-6 mb-2">
