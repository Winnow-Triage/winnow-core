...
import { getMyTeams, getTeamMetrics, type TeamDashboardMetrics } from "@/lib/api"
        ...
        return (
            <div className="p-8">
                <div className="text-center py-12 border rounded-lg bg-muted/20">
                    ...
                    <p className="text-muted-foreground mt-1">You are not a member of any teams in this organization.</p>
                </div>
            </div>
        )
    }
            ...
            {error ? (
                <div className="bg-destructive/15 text-destructive p-4 rounded-md border border-destructive/20 flex gap-2 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm">Failed to load team metrics. {(error as Error).message}</p>
                    </div>
                </div>
            ) : isLoadingMetrics ? (
                    ...
                    <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
                        ...
                        <Card className="col-span-1">
                            <CardHeader>
                                ...
                                <CardDescription>Error volumes and active clusters across {metrics.projectBreakdown.length} projects.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Table>
                                    <TableHeader>
                    ...
                    <div className="grid gap-6 grid-cols-1">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Signal vs noise across all team projects.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <TriageFunnelChart
