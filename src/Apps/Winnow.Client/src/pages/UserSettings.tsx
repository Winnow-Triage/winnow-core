  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      const isEmailChanged =
        email.trim().toLowerCase() !== storedUser.email?.toLowerCase();
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground italic">
                  Note: Changing your email will also change your login
                  username.
                </p>
              </div>
              <div className="space-y-2">
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Quickly switch between workspaces you belong to.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
