...
export default function OrganizationDashboard() {
            ...
            <div className="p-8">
                <div className="bg-destructive/15 text-destructive p-4 rounded-md border border-destructive/20 flex gap-2 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm">Failed to load organization metrics. {(error as Error).message}</p>
                    </div>
                </div>
            </div>
        )
    ...
    const quotaPercentage = hasLimit ? Math.min((data.quota.totalUsage / data.quota.baseLimit!) * 100, 100) : 0;
    const isNearingLimit = hasLimit && quotaPercentage >= 80 && !data.quota.isOverage;
                    ...
                    <CardHeader className="pb-2">
                        ...
                        <div className="flex items-baseline gap-1 mt-1">
                            ...
                            <span className="text-sm text-muted-foreground">
                                {hasLimit ? `/ ${data.quota.baseLimit!.toLocaleString()}` : " reports"}
                            </span>
                        </div>
                    </CardHeader>
                    <CardContent>
                        {hasLimit ? (
                            ...
                            <div className="space-y-4 mt-4">
                                ...
                                <div className="flex justify-between text-xs text-muted-foreground border-t pt-2 border-dashed">
                                    ...
                                    <span className="text-primary font-medium">Unlimited Quota</span>
                                </div>
                            </div>
                        )}
                    </CardContent>
            ...
            <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
                ...
                <Card className="col-span-1">
                    <CardHeader>
                        ...
                        <CardDescription>Report volume generated by teams this month.</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="col-span-1">
                    <CardHeader>
                        ...
                        <CardDescription>Projects with the highest report volume (30 days).</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
                                ...
                                {data.topProjects.length > 0 ? (
                                    data.topProjects.map((project) => (
                                        <TableRow key={project.projectId}>
                                            ...
                                            <TableCell className="text-right">{project.reportCount.toLocaleString()}</TableCell>
