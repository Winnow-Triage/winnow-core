...
export function Features() {
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <Section border="bottom" padding="large" containerClassName="text-center">
                ...
                <div className="max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
                        ...
                        <GradientText>powered by vectors.</GradientText>
                    </h1>
            ...
            {/* Core Features Grid */}
            <Section variant="muted" padding="large">
            ...
            <Section variant="slate" border="both">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            <Card isHoverable={false} className="p-6 rounded-2xl bg-card hover:bg-accent/5 transition-colors">
